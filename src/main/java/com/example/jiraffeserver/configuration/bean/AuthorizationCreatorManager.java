...
public class AuthorizationCreatorManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    public AuthorizationDecision check(Supplier<Authentication> authentication, RequestAuthorizationContext context) {
        ...
        boolean canAccess = organization.getCreatedBy().getId().equals(currentUserId);
